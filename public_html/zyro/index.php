<?php
	...
	$pages = array(
		...
		'1'	=> array('id' => '4', 'alias' => 'Popular', 'file' => '4.php','controllers' => array()),
		'2'	=> array('id' => '5', 'alias' => 'Humour', 'file' => '5.php','controllers' => array()),
		'3'	=> array('id' => '2', 'alias' => 'Movies', 'file' => '2.php','controllers' => array()),
	...
	$base_url = '/zyro/';
	$user_domain = 'faks2017.000webhostapp.com';
	$show_comments = false;
	require_once dirname(__FILE__).'/functions.inc.php';
	$home_page = '1';
	list($page_id, $lang, $urlArgs, $route) = parse_uri();
	$user_key = "fzwXTArYNNLr3SQfFN0tNH+dxa/H3iw/hpM=";
	$user_hash = "e36d076858896439";
